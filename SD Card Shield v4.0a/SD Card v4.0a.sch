...
<libraries>
<library name="SD card breakout">
<packages>
<package name="SDCARDEXTPACKAGE">
<wire x1="-15.1" y1="-14.6" x2="7.3" y2="-14.6" width="0" layer="21"/>
<wire x1="7.3" y1="-14.6" x2="13.4" y2="-14.6" width="0" layer="21"/>
<wire x1="13.4" y1="-14.6" x2="13.4" y2="13.9" width="0" layer="21"/>
<wire x1="13.4" y1="13.9" x2="-15.1" y2="13.9" width="0" layer="21"/>
<wire x1="-15.1" y1="13.9" x2="-15.1" y2="-14.6" width="0" layer="21"/>
<wire x1="7.3" y1="-14.6" x2="7.4" y2="-14.6" width="0" layer="21"/>
<smd name="WP" x="-15.8" y="-14" dx="1.5" dy="0.7" layer="1" rot="R180"/>
<smd name="DATA1(IRQ)" x="-15.8" y="-10.9" dx="1.5" dy="0.7" layer="1" rot="R180"/>
<smd name="(DATA0)D0" x="-15.8" y="-9.2" dx="1.5" dy="0.7" layer="1" rot="R180"/>
<smd name="VSS2(GND)" x="-15.8" y="-6.7" dx="1.5" dy="0.7" layer="1" rot="R180"/>
<smd name="CLK(CLK)" x="-15.8" y="-4.2" dx="1.5" dy="0.7" layer="1" rot="R180"/>
<smd name="VDD(VCC)" x="-15.8" y="-1.7" dx="1.5" dy="0.7" layer="1" rot="R180"/>
<smd name="CMD(DI)" x="-15.8" y="3.4" dx="1.5" dy="0.7" layer="1" rot="R180"/>
<smd name="CD/DATA3(CS)" x="-15.8" y="5.9" dx="1.5" dy="0.7" layer="1" rot="R180"/>
<smd name="DATA2(P9)" x="-15.8" y="8.4" dx="1.5" dy="0.7" layer="1" rot="R180"/>
<smd name="P$2" x="5.2" y="13.6" dx="1.5" dy="2" layer="1" rot="R90"/>
<smd name="COM" x="6.2" y="-14.3" dx="1.5" dy="2" layer="1" rot="R90"/>
<smd name="VSS1(GND)" x="-15.8" y="0.9" dx="2.5" dy="1.5" layer="1" rot="R90"/>
<text x="-6.35" y="13.97" size="1.27" layer="25">&gt;name</text>
<hole x="8.4" y="10.8" drill="2"/>
<hole x="8.5" y="-13.1" drill="2"/>
</package>
</packages>
<symbols>
<symbol name="SDCARDEXTSYMBOL">
<wire x1="13.97" y1="11.43" x2="-13.97" y2="11.43" width="0.127" layer="94"/>
<wire x1="-13.97" y1="11.43" x2="-13.97" y2="-16.51" width="0.127" layer="94"/>
<wire x1="13.97" y1="-16.51" x2="13.97" y2="11.43" width="0.127" layer="94"/>
<wire x1="-13.97" y1="-16.51" x2="-13.97" y2="-19.05" width="0.127" layer="94"/>
<wire x1="-13.97" y1="-19.05" x2="13.97" y2="-19.05" width="0.127" layer="94"/>
<wire x1="13.97" y1="-19.05" x2="13.97" y2="-16.51" width="0.127" layer="94"/>
<text x="-13.97" y="11.43" size="1.27" layer="95">&gt;name</text>
<text x="-7.62" y="11.43" size="1.27" layer="96">&gt;value</text>
<pin name="DATA2(P9)" x="-16.51" y="8.89" length="middle" function="dotclk"/>
<pin name="CD/DATA3(CS/CD)" x="-16.51" y="6.35" length="middle"/>
<pin name="CMD(DI)" x="-16.51" y="3.81" length="middle"/>
<pin name="VSS1(GND)" x="-16.51" y="1.27" length="middle"/>
<pin name="VDD(VCC)" x="-16.51" y="-1.27" length="middle"/>
<pin name="CLK(CLK)" x="-16.51" y="-3.81" length="middle"/>
<pin name="VSS2(GND)" x="-16.51" y="-6.35" length="middle"/>
<pin name="DATA0(DO)" x="-16.51" y="-8.89" length="middle"/>
<pin name="DATA1(IRQ)" x="-16.51" y="-11.43" length="middle"/>
<pin name="WP" x="-16.51" y="-13.97" length="middle"/>
<pin name="COM" x="-16.51" y="-16.51" length="middle"/>
</symbol>
</symbols>
<devicesets>
<deviceset name="SDCARDEXTDEVICE" prefix="X" uservalue="yes">
<gates>
<gate name="G$1" symbol="SDCARDEXTSYMBOL" x="-20.32" y="22.86"/>
</gates>
<devices>
<device name="" package="SDCARDEXTPACKAGE">
<connects>
<connect gate="G$1" pin="CD/DATA3(CS/CD)" pad="CD/DATA3(CS)"/>
<connect gate="G$1" pin="CLK(CLK)" pad="CLK(CLK)"/>
<connect gate="G$1" pin="CMD(DI)" pad="CMD(DI)"/>
<connect gate="G$1" pin="COM" pad="COM"/>
<connect gate="G$1" pin="DATA0(DO)" pad="(DATA0)D0"/>
<connect gate="G$1" pin="DATA1(IRQ)" pad="DATA1(IRQ)"/>
<connect gate="G$1" pin="DATA2(P9)" pad="DATA2(P9)"/>
<connect gate="G$1" pin="VDD(VCC)" pad="VDD(VCC)"/>
<connect gate="G$1" pin="VSS1(GND)" pad="VSS1(GND)"/>
<connect gate="G$1" pin="VSS2(GND)" pad="VSS2(GND)"/>
...
<text x="-3.81" y="-3.81" size="1.778" layer="27" ratio="10">&gt;VALUE</text>
</package>
<package name="AVX-A">
...
<text x="-2.032" y="-2.413" size="0.8128" layer="27" ratio="10">&gt;VALUE</text>
...
<text x="-3.937" y="2.54" size="1.778" layer="25" ratio="10">&gt;NAME</text>
<text x="-4.572" y="-4.318" size="1.778" layer="27" ratio="10">&gt;VALUE</text>
...
<text x="-2.921" y="3.175" size="1.27" layer="25" ratio="10">&gt;NAME</text>
<text x="-3.683" y="-4.445" size="1.27" layer="27" ratio="10">&gt;VALUE</text>
...
<text x="-4.953" y="12.7" size="1.778" layer="25" ratio="10">&gt;name</text>
<text x="-4.953" y="10.541" size="1.778" layer="27" ratio="10">&gt;value</text>
...
<pad name="-" x="2.54" y="0" drill="0.635" diameter="1.524" shape="long" rot="R90"/>
<text x="-6.35" y="-3.81" size="0.6096" layer="46">2 Slot drills with copper</text>
<text x="-3.429" y="8.509" size="1.27" layer="25" ratio="10">&gt;name</text>
<text x="-3.683" y="6.985" size="1.27" layer="27" ratio="10">&gt;value</text>
...
<text x="-3.175" y="7.366" size="1.27" layer="25">&gt;name</text>
<text x="-3.175" y="5.715" size="1.27" layer="27">&gt;value</text>
<text x="-7.62" y="-0.635" size="1.9304" layer="21" ratio="10">+</text>
<text x="-0.508" y="0" size="0.254" layer="33">&gt;name</text>
</package>
<package name="ELECTRO-8.6MM">
<circle x="0" y="0" radius="4.2597" width="0.127" layer="21"/>
...
<text x="-3.429" y="5.969" size="1.27" layer="25">&gt;name</text>
<text x="-3.683" y="4.445" size="1.27" layer="27">&gt;value</text>
...
<text x="-2.159" y="4.064" size="0.8128" layer="25" ratio="10">&gt;name</text>
...
<text x="-4.572" y="10.668" size="1.778" layer="25" ratio="10">&gt;NAME</text>
...
<package name="ELECTRO-8.2MM">
<circle x="0" y="0" radius="4.0894" width="0.127" layer="21"/>
<pad name="1" x="-1.524" y="0" drill="0.889" diameter="1.651" shape="square"/>
<pad name="2" x="1.524" y="0" drill="0.889" diameter="1.651"/>
<text x="-5.715" y="-0.635" size="1.778" layer="21" ratio="10">+</text>
<circle x="0" y="0" radius="4.0894" width="0.127" layer="39"/>
<text x="-4.445" y="4.445" size="1.778" layer="25" ratio="10">&gt;NAME</text>
<text x="-5.08" y="-6.35" size="1.778" layer="27" ratio="10">&gt;VALUE</text>
</package>
...
<text x="1.778" y="4.064" size="0.8128" layer="25" ratio="10" rot="R180">&gt;NAME</text>
<text x="2.413" y="3.048" size="0.8128" layer="27" ratio="10" rot="R180">&gt;VALUE</text>
...
<smd name="+" x="2.032" y="0" dx="2.54" dy="1.524" layer="1"/>
<text x="-2.54" y="2.794" size="0.8128" layer="25" ratio="10">&gt;NAME</text>
...
<smd name="+" x="3.429" y="0" dx="3.81" dy="1.905" layer="1"/>
<text x="-4.064" y="4.445" size="1.778" layer="25" ratio="10">&gt;NAME</text>
<text x="-4.064" y="-6.35" size="1.778" layer="27" ratio="10">&gt;VALUE</text>
...
<smd name="+" x="4.318" y="0" dx="4.064" dy="1.905" layer="1"/>
<text x="-4.445" y="5.461" size="1.778" layer="25" ratio="10">&gt;NAME</text>
<text x="-4.445" y="-7.239" size="1.778" layer="27" ratio="10">&gt;VALUE</text>
...
<smd name="+" x="4.191" y="0" dx="3.81" dy="1.524" layer="1"/>
<text x="-5.08" y="5.334" size="1.778" layer="25" ratio="10">&gt;NAME</text>
<text x="-4.963" y="-7.374" size="1.778" layer="27" ratio="10">&gt;VALUE</text>
<rectangle x1="-5.08" y1="-5.08" x2="5.08" y2="5.08" layer="39"/>
</package>
...
<smd name="+" x="2.667" y="0" dx="2.54" dy="1.397" layer="1"/>
<text x="-3.81" y="3.556" size="1.778" layer="25" ratio="10">&gt;NAME</text>
...
<text x="-7.62" y="0" size="1.27" layer="95" ratio="10">&gt;name</text>
...
<device name="-D8.6/3.81" package="ELECTRO-8.6MM">
<connects>
<connect gate="C" pin="+" pad="+"/>
<connect gate="C" pin="-" pad="-"/>
</connects>
...
<device name="-D8.2/3.05" package="ELECTRO-8.2MM">
<connects>
...
<wire x1="42.926" y1="49.53" x2="22.606" y2="49.53" width="0.127" layer="21"/>
<wire x1="22.606" y1="49.53" x2="22.606" y2="52.07" width="0.127" layer="21"/>
<wire x1="22.606" y1="52.07" x2="42.926" y2="52.07" width="0.127" layer="21"/>
...
<wire x1="31.75" y1="3.81" x2="46.99" y2="3.81" width="0.127" layer="21"/>
<wire x1="46.99" y1="3.81" x2="46.99" y2="1.27" width="0.127" layer="21"/>
<wire x1="46.99" y1="1.27" x2="31.75" y2="1.27" width="0.127" layer="21"/>
...
<wire x1="0" y1="0" x2="0" y2="53.34" width="0.0254" layer="49"/>
<wire x1="0" y1="53.34" x2="64.516" y2="53.34" width="0.0254" layer="49"/>
<wire x1="64.516" y1="53.34" x2="66.04" y2="51.816" width="0.0254" layer="49"/>
<wire x1="66.04" y1="51.816" x2="66.04" y2="40.386" width="0.0254" layer="49"/>
<wire x1="66.04" y1="40.386" x2="68.58" y2="37.846" width="0.0254" layer="49"/>
<wire x1="68.58" y1="37.846" x2="68.58" y2="5.08" width="0.0254" layer="49"/>
<wire x1="68.58" y1="5.08" x2="66.04" y2="2.54" width="0.0254" layer="49"/>
<wire x1="66.04" y1="2.54" x2="66.04" y2="0" width="0.0254" layer="49"/>
<wire x1="66.04" y1="0" x2="0" y2="0" width="0.0254" layer="49"/>
...
<pad name="17" x="50.8" y="2.54" drill="0.889" diameter="1.651" shape="square"/>
<pad name="18" x="53.34" y="2.54" drill="0.889" diameter="1.651"/>
<pad name="19" x="55.88" y="2.54" drill="0.889" diameter="1.651"/>
<pad name="20" x="58.42" y="2.54" drill="0.889" diameter="1.651"/>
<pad name="21" x="60.96" y="2.54" drill="0.889" diameter="1.651"/>
<pad name="22" x="63.5" y="2.54" drill="0.889" diameter="1.651"/>
<pad name="23" x="45.72" y="2.54" drill="0.889" diameter="1.651" shape="square"/>
<pad name="24" x="43.18" y="2.54" drill="0.889" diameter="1.651"/>
<pad name="25" x="40.64" y="2.54" drill="0.889" diameter="1.651"/>
<pad name="26" x="38.1" y="2.54" drill="0.889" diameter="1.651"/>
<pad name="27" x="35.56" y="2.54" drill="0.889" diameter="1.651"/>
<pad name="28" x="33.02" y="2.54" drill="0.889" diameter="1.651"/>
<pad name="36" x="63.5" y="30.48" drill="0.889" diameter="1.651" shape="square"/>
<pad name="32" x="66.04" y="27.94" drill="0.889" diameter="1.651"/>
<pad name="33" x="66.04" y="25.4" drill="0.889" diameter="1.651"/>
<pad name="34" x="63.5" y="25.4" drill="0.889" diameter="1.651"/>
<pad name="35" x="63.5" y="27.94" drill="0.889" diameter="1.651"/>
<pad name="31" x="66.04" y="30.48" drill="0.889" diameter="1.651"/>
<text x="63.119" y="47.625" size="1.27" layer="21" ratio="10">0</text>
<text x="60.579" y="47.625" size="1.27" layer="21" ratio="10">1</text>
<text x="52.959" y="4.445" size="1.27" layer="21" ratio="10">1</text>
<text x="58.039" y="47.625" size="1.27" layer="21" ratio="10">2</text>
<text x="55.499" y="47.625" size="1.27" layer="21" ratio="10">3</text>
<text x="52.959" y="47.625" size="1.27" layer="21" ratio="10">4</text>
<text x="50.419" y="47.625" size="1.27" layer="21" ratio="10">5</text>
<text x="47.879" y="47.625" size="1.27" layer="21" ratio="10">6</text>
<text x="45.339" y="47.625" size="1.27" layer="21" ratio="10">7</text>
<text x="41.148" y="47.625" size="1.27" layer="21" ratio="10">8</text>
<text x="38.608" y="47.625" size="1.27" layer="21" ratio="10">9</text>
<text x="36.068" y="47.625" size="1.27" layer="21" ratio="10">1</text>
<text x="33.528" y="47.625" size="1.27" layer="21" ratio="10">1</text>
<text x="30.988" y="47.498" size="1.27" layer="21" ratio="10">1</text>
<text x="28.448" y="47.498" size="1.27" layer="21" ratio="10">1</text>
<text x="26.924" y="45.593" size="1.27" layer="21" ratio="10" rot="R90">GND</text>
<text x="28.448" y="45.974" size="1.27" layer="21" ratio="10">3</text>
<text x="30.988" y="45.974" size="1.27" layer="21" ratio="10">2</text>
<text x="33.528" y="45.974" size="1.27" layer="21" ratio="10">1</text>
<text x="36.068" y="45.974" size="1.27" layer="21" ratio="10">0</text>
...
<text x="53.975" y="6.35" size="1.27" layer="21" ratio="10">ANALOG</text>
...
<text x="48.895" y="37.973" size="0.889" layer="51" ratio="11" rot="R90">I2C</text>
<text x="57.785" y="36.83" size="0.889" layer="51" ratio="11" rot="R90">SERIAL</text>
</package>
<package name="ARDUINO-W/O-SILK">
<wire x1="42.926" y1="52.07" x2="42.926" y2="49.53" width="0.127" layer="21"/>
<wire x1="42.926" y1="49.53" x2="22.606" y2="49.53" width="0.127" layer="21"/>
<wire x1="22.606" y1="49.53" x2="22.606" y2="52.07" width="0.127" layer="21"/>
<wire x1="22.606" y1="52.07" x2="42.926" y2="52.07" width="0.127" layer="21"/>
...
<hole x="66.04" y="35.56" drill="3.2004"/>
<hole x="66.04" y="7.62" drill="3.2004"/>
<wire x1="67.31" y1="31.75" x2="62.23" y2="31.75" width="0.127" layer="22"/>
<wire x1="62.23" y1="31.75" x2="62.23" y2="24.13" width="0.127" layer="22"/>
<wire x1="62.23" y1="24.13" x2="67.31" y2="24.13" width="0.127" layer="22"/>
<wire x1="67.31" y1="24.13" x2="67.31" y2="31.75" width="0.127" layer="22"/>
<rectangle x1="62.23" y1="24.13" x2="67.31" y2="31.75" layer="40" rot="R180"/>
<smd name="36" x="62.357" y="30.48" dx="2.286" dy="1.524" layer="16" rot="R180"/>
<smd name="35" x="62.357" y="27.94" dx="2.286" dy="1.524" layer="16" roundness="50" rot="R180"/>
<smd name="34" x="62.357" y="25.4" dx="2.286" dy="1.524" layer="16" roundness="50" rot="R180"/>
<smd name="33" x="67.183" y="25.4" dx="2.286" dy="1.524" layer="16" roundness="50"/>
<smd name="32" x="67.183" y="27.94" dx="2.286" dy="1.524" layer="16" roundness="50"/>
<smd name="31" x="67.183" y="30.48" dx="2.286" dy="1.524" layer="16" roundness="50"/>
<text x="24.384" y="44.45" size="1.27" layer="21" ratio="10" rot="R90">AREF</text>
</package>
</packages>
<symbols>
<symbol name="ARDUINO">
...
<devicesets>
<deviceset name="ARDUINO" prefix="U" uservalue="yes">
<gates>
<gate name="ARDUINO" symbol="ARDUINO" x="0" y="0"/>
</gates>
<devices>
<device name="'W/-SILK" package="ARDUINO">
<connects>
<connect gate="ARDUINO" pin="3V3" pad="27"/>
<connect gate="ARDUINO" pin="5V" pad="26"/>
<connect gate="ARDUINO" pin="AREF" pad="16"/>
<connect gate="ARDUINO" pin="GND" pad="33"/>
<connect gate="ARDUINO" pin="GND@0" pad="15"/>
<connect gate="ARDUINO" pin="GND@1" pad="24"/>
<connect gate="ARDUINO" pin="GND@2" pad="25"/>
<connect gate="ARDUINO" pin="MISO" pad="36"/>
<connect gate="ARDUINO" pin="MOSI" pad="32"/>
<connect gate="ARDUINO" pin="PB0/D8" pad="9"/>
<connect gate="ARDUINO" pin="PB1/D9/PWM" pad="10"/>
<connect gate="ARDUINO" pin="PB2/D10/SS/PWM" pad="11"/>
<connect gate="ARDUINO" pin="PB3/D11/MOSI/PWM" pad="12"/>
<connect gate="ARDUINO" pin="PB4/D12/MISO" pad="13"/>
<connect gate="ARDUINO" pin="PB5/D13/SCK" pad="14"/>
<connect gate="ARDUINO" pin="PC0/AD0/D14" pad="17"/>
<connect gate="ARDUINO" pin="PC1/AD1/D15" pad="18"/>
<connect gate="ARDUINO" pin="PC2/AD2/D16" pad="19"/>
<connect gate="ARDUINO" pin="PC3/AD3/D17" pad="20"/>
<connect gate="ARDUINO" pin="PC4/AD4/D18/SDA" pad="21"/>
<connect gate="ARDUINO" pin="PC5/AD5/D19/SCL" pad="22"/>
<connect gate="ARDUINO" pin="PD0/D0/RX" pad="1"/>
<connect gate="ARDUINO" pin="PD1/D1/TX" pad="2"/>
<connect gate="ARDUINO" pin="PD2/D2/INT0" pad="3"/>
<connect gate="ARDUINO" pin="PD3/D3/INT1/PWM" pad="4"/>
<connect gate="ARDUINO" pin="PD4/D4" pad="5"/>
<connect gate="ARDUINO" pin="PD5/D5/PWM" pad="6"/>
<connect gate="ARDUINO" pin="PD6/D6/PWM" pad="7"/>
<connect gate="ARDUINO" pin="PD7/D7" pad="8"/>
<connect gate="ARDUINO" pin="RESET" pad="28"/>
<connect gate="ARDUINO" pin="RST" pad="34"/>
<connect gate="ARDUINO" pin="SCK" pad="35"/>
<connect gate="ARDUINO" pin="VCC" pad="31"/>
<connect gate="ARDUINO" pin="VIN" pad="23"/>
</connects>
<technologies>
<technology name=""/>
</technologies>
</device>
<device name="'W/O-SILK'" package="ARDUINO-W/O-SILK">
<connects>
<connect gate="ARDUINO" pin="3V3" pad="27"/>
<connect gate="ARDUINO" pin="5V" pad="26"/>
<connect gate="ARDUINO" pin="AREF" pad="16"/>
...
<device name="" package="ARDUINO-ISP-SMD">
<connects>
<connect gate="ARDUINO" pin="3V3" pad="27"/>
<connect gate="ARDUINO" pin="5V" pad="26"/>
<connect gate="ARDUINO" pin="AREF" pad="16"/>
...
<devicesets>
<deviceset name="74V*125" prefix="U">
...
<parts>
<part name="X1" library="SD card breakout" deviceset="SDCARDEXTDEVICE" device=""/>
<part name="UART" library="Connector" deviceset="TWIG-4P-2.0" device="-2.0"/>
<part name="I2C" library="Connector" deviceset="TWIG-4P-2.0" device="-2.0"/>
<part name="U2" library="moudle" deviceset="ARDUINO" device="'W/-SILK"/>
<part name="U1" library="IC" deviceset="74V*125" device="PW" technology="HC"/>
<part name="U3" library="IC" deviceset="XC6206" device="MR"/>
<part name="C3" library="Discrete" deviceset="C*" device="-0805" value="10uF"/>
<part name="C4" library="Discrete" deviceset="C*" device="-0805" value="1uF"/>
<part name="C1" library="Discrete" deviceset="C*" device="-0805" value="10uF"/>
<part name="C2" library="Discrete" deviceset="CAP*" device="-AVX-A"/>
<part name="R1" library="Discrete" deviceset="R*" device="-0603"/>
<part name="R2" library="Discrete" deviceset="R*" device="-0603"/>
<part name="R3" library="Discrete" deviceset="R*" device="-0603"/>
...
<instances>
<instance part="X1" gate="G$1" x="-3.81" y="11.43" rot="R180"/>
<instance part="UART" gate="G$1" x="-15.24" y="-15.24" smashed="yes" rot="R180">
<attribute name="NAME" x="-14.732" y="-23.368" size="1.27" layer="95" rot="R180"/>
<attribute name="VALUE" x="-4.572" y="-21.336" size="1.27" layer="96" rot="R180"/>
</instance>
<instance part="I2C" gate="G$1" x="12.7" y="-15.24" smashed="yes" rot="R180">
<attribute name="NAME" x="11.303" y="-23.368" size="1.27" layer="95" rot="R180"/>
<attribute name="VALUE" x="23.368" y="-21.336" size="1.27" layer="96" rot="R180"/>
</instance>
<instance part="U2" gate="ARDUINO" x="-165.1" y="8.89"/>
<instance part="U1" gate="C" x="-62.23" y="43.18"/>
<instance part="U1" gate="PWR" x="-64.77" y="63.5" smashed="yes" rot="R270">
<attribute name="NAME" x="-68.58" y="59.69" size="1.778" layer="95"/>
<attribute name="VALUE" x="-71.12" y="68.58" size="1.778" layer="96"/>
</instance>
<instance part="U1" gate="A" x="-62.23" y="24.13"/>
<instance part="U1" gate="B" x="-62.23" y="5.08"/>
<instance part="U1" gate="D" x="-62.23" y="-19.05"/>
<instance part="U3" gate="G$1" x="0" y="60.96"/>
<instance part="C3" gate="C" x="-13.97" y="53.34" rot="R90"/>
<instance part="C4" gate="C" x="15.24" y="53.34" rot="R90"/>
<instance part="C1" gate="C" x="19.05" y="53.34" rot="R90"/>
<instance part="C2" gate="C" x="26.67" y="53.34" rot="R270"/>
<instance part="R1" gate="R" x="-80.01" y="43.18"/>
<instance part="R2" gate="R" x="-80.01" y="24.13"/>
<instance part="R3" gate="R" x="-80.01" y="5.08"/>
<instance part="R4" gate="R" x="-80.01" y="-19.05"/>
</instances>
<busses>
</busses>
<nets>
...
<label x="29.21" y="5.08" size="1.778" layer="95"/>
<pinref part="X1" gate="G$1" pin="CD/DATA3(CS/CD)"/>
</segment>
<segment>
<pinref part="U1" gate="D" pin="!OE"/>
<wire x1="-62.23" y1="-27.94" x2="-62.23" y2="-30.48" width="0.1524" layer="91"/>
<wire x1="-62.23" y1="-30.48" x2="-53.34" y2="-30.48" width="0.1524" layer="91"/>
<label x="-58.42" y="-30.48" size="1.778" layer="95"/>
</segment>
<segment>
<pinref part="U1" gate="C" pin="Y"/>
<wire x1="-53.34" y1="43.18" x2="-46.99" y2="43.18" width="0.1524" layer="91"/>
<label x="-49.53" y="43.18" size="1.778" layer="95"/>
</segment>
</net>
<net name="SD_DI" class="0">
<segment>
<wire x1="12.7" y1="7.62" x2="35.56" y2="7.62" width="0.1524" layer="91"/>
<label x="29.21" y="7.62" size="1.778" layer="95"/>
<pinref part="X1" gate="G$1" pin="CMD(DI)"/>
</segment>
<segment>
<pinref part="U1" gate="A" pin="Y"/>
<wire x1="-53.34" y1="24.13" x2="-46.99" y2="24.13" width="0.1524" layer="91"/>
<label x="-49.53" y="24.13" size="1.778" layer="95"/>
</segment>
</net>
...
<pinref part="X1" gate="G$1" pin="CLK(CLK)"/>
</segment>
<segment>
<pinref part="U1" gate="B" pin="Y"/>
<wire x1="-53.34" y1="5.08" x2="-46.99" y2="5.08" width="0.1524" layer="91"/>
...
<pinref part="X1" gate="G$1" pin="VSS2(GND)"/>
</segment>
<segment>
<wire x1="12.7" y1="10.16" x2="35.56" y2="10.16" width="0.1524" layer="91"/>
<label x="29.21" y="10.16" size="1.778" layer="95"/>
<pinref part="X1" gate="G$1" pin="VSS1(GND)"/>
</segment>
<segment>
<wire x1="-11.43" y1="-11.43" x2="-6.35" y2="-11.43" width="0.1524" layer="91"/>
<label x="-5.08" y="-11.43" size="1.778" layer="95"/>
<pinref part="UART" gate="G$1" pin="4"/>
</segment>
<segment>
<wire x1="16.51" y1="-11.43" x2="24.13" y2="-11.43" width="0.1524" layer="91"/>
<label x="19.05" y="-11.43" size="1.778" layer="95"/>
<pinref part="I2C" gate="G$1" pin="4"/>
</segment>
<segment>
<pinref part="U2" gate="ARDUINO" pin="GND@2"/>
<wire x1="-173.99" y1="-21.59" x2="-173.99" y2="-30.48" width="0.1524" layer="91"/>
<label x="-173.99" y="-30.48" size="1.778" layer="95" rot="R90"/>
</segment>
<segment>
<pinref part="U2" gate="ARDUINO" pin="GND@1"/>
<wire x1="-171.45" y1="-30.48" x2="-171.45" y2="-21.59" width="0.1524" layer="91"/>
<label x="-171.45" y="-30.48" size="1.778" layer="95" rot="R90"/>
</segment>
<segment>
<pinref part="U2" gate="ARDUINO" pin="GND"/>
<wire x1="-127" y1="10.16" x2="-120.65" y2="10.16" width="0.1524" layer="91"/>
...
<wire x1="-13.97" y1="49.53" x2="-13.97" y2="48.26" width="0.1524" layer="91"/>
<wire x1="-13.97" y1="48.26" x2="0" y2="48.26" width="0.1524" layer="91"/>
<junction x="0" y="48.26"/>
<pinref part="C4" gate="C" pin="1"/>
<wire x1="15.24" y1="49.53" x2="15.24" y2="48.26" width="0.1524" layer="91"/>
...
<wire x1="19.05" y1="48.26" x2="19.05" y2="49.53" width="0.1524" layer="91"/>
<junction x="15.24" y="48.26"/>
<pinref part="C2" gate="C" pin="-"/>
<wire x1="26.67" y1="49.53" x2="26.67" y2="48.26" width="0.1524" layer="91"/>
<wire x1="26.67" y1="48.26" x2="19.05" y2="48.26" width="0.1524" layer="91"/>
<junction x="19.05" y="48.26"/>
</segment>
<segment>
<pinref part="U2" gate="ARDUINO" pin="GND@0"/>
<wire x1="-184.15" y1="39.37" x2="-184.15" y2="44.45" width="0.1524" layer="91"/>
<label x="-184.15" y="41.91" size="1.778" layer="95" rot="R90"/>
</segment>
<segment>
<pinref part="U1" gate="C" pin="!OE"/>
<wire x1="-62.23" y1="34.29" x2="-62.23" y2="31.75" width="0.1524" layer="91"/>
<wire x1="-62.23" y1="31.75" x2="-53.34" y2="31.75" width="0.1524" layer="91"/>
<label x="-59.69" y="31.75" size="1.778" layer="95"/>
</segment>
<segment>
<pinref part="U1" gate="A" pin="!OE"/>
<wire x1="-62.23" y1="15.24" x2="-62.23" y2="12.7" width="0.1524" layer="91"/>
<wire x1="-62.23" y1="12.7" x2="-53.34" y2="12.7" width="0.1524" layer="91"/>
<label x="-59.69" y="12.7" size="1.778" layer="95"/>
</segment>
<segment>
<pinref part="U1" gate="B" pin="!OE"/>
<wire x1="-62.23" y1="-3.81" x2="-62.23" y2="-6.35" width="0.1524" layer="91"/>
<wire x1="-62.23" y1="-6.35" x2="-53.34" y2="-6.35" width="0.1524" layer="91"/>
<label x="-58.42" y="-6.35" size="1.778" layer="95"/>
</segment>
</net>
<net name="SD_DO" class="0">
<segment>
<wire x1="12.7" y1="20.32" x2="35.56" y2="20.32" width="0.1524" layer="91"/>
<label x="29.21" y="20.32" size="1.778" layer="95"/>
<pinref part="X1" gate="G$1" pin="DATA0(DO)"/>
</segment>
<segment>
<label x="-92.71" y="-19.05" size="1.778" layer="95"/>
<pinref part="R4" gate="R" pin="1"/>
<wire x1="-83.82" y1="-19.05" x2="-92.71" y2="-19.05" width="0.1524" layer="91"/>
</segment>
</net>
<net name="CS_A" class="0">
<segment>
<pinref part="U2" gate="ARDUINO" pin="PD4/D4"/>
<wire x1="-156.21" y1="39.37" x2="-156.21" y2="44.45" width="0.1524" layer="91"/>
<label x="-156.21" y="41.91" size="1.778" layer="95" rot="R90"/>
</segment>
<segment>
...
<net name="DI_A" class="0">
<segment>
<pinref part="U2" gate="ARDUINO" pin="MOSI"/>
<wire x1="-127" y1="12.7" x2="-120.65" y2="12.7" width="0.1524" layer="91"/>
<label x="-124.46" y="12.7" size="1.778" layer="95"/>
</segment>
<segment>
<label x="-92.71" y="24.13" size="1.778" layer="95"/>
<pinref part="R2" gate="R" pin="1"/>
<wire x1="-83.82" y1="24.13" x2="-92.71" y2="24.13" width="0.1524" layer="91"/>
</segment>
</net>
<net name="CLK_A" class="0">
<segment>
<pinref part="U2" gate="ARDUINO" pin="SCK"/>
<wire x1="-127" y1="5.08" x2="-120.65" y2="5.08" width="0.1524" layer="91"/>
<label x="-124.46" y="5.08" size="1.778" layer="95"/>
</segment>
<segment>
<label x="-92.71" y="5.08" size="1.778" layer="95"/>
<pinref part="R3" gate="R" pin="1"/>
<wire x1="-83.82" y1="5.08" x2="-92.71" y2="5.08" width="0.1524" layer="91"/>
</segment>
</net>
<net name="3V3" class="0">
<segment>
<wire x1="12.7" y1="12.7" x2="35.56" y2="12.7" width="0.1524" layer="91"/>
<label x="29.21" y="12.7" size="1.778" layer="95"/>
<pinref part="X1" gate="G$1" pin="VDD(VCC)"/>
</segment>
<segment>
<pinref part="U3" gate="G$1" pin="VOUT"/>
<wire x1="12.7" y1="60.96" x2="15.24" y2="60.96" width="0.1524" layer="91"/>
<label x="16.51" y="60.96" size="1.778" layer="95"/>
<pinref part="C4" gate="C" pin="2"/>
<wire x1="15.24" y1="60.96" x2="19.05" y2="60.96" width="0.1524" layer="91"/>
<wire x1="19.05" y1="60.96" x2="26.67" y2="60.96" width="0.1524" layer="91"/>
<wire x1="15.24" y1="57.15" x2="15.24" y2="60.96" width="0.1524" layer="91"/>
<junction x="15.24" y="60.96"/>
<pinref part="C1" gate="C" pin="2"/>
<wire x1="19.05" y1="57.15" x2="19.05" y2="60.96" width="0.1524" layer="91"/>
<junction x="19.05" y="60.96"/>
<pinref part="C2" gate="C" pin="+"/>
<wire x1="26.67" y1="60.96" x2="26.67" y2="57.15" width="0.1524" layer="91"/>
</segment>
</net>
<net name="SCL" class="0">
<segment>
<pinref part="U2" gate="ARDUINO" pin="PC5/AD5/D19/SCL"/>
<wire x1="-146.05" y1="-21.59" x2="-146.05" y2="-30.48" width="0.1524" layer="91"/>
<label x="-146.05" y="-30.48" size="1.778" layer="95" rot="R90"/>
</segment>
<segment>
<wire x1="16.51" y1="-19.05" x2="24.13" y2="-19.05" width="0.1524" layer="91"/>
<label x="19.05" y="-19.05" size="1.778" layer="95"/>
<pinref part="I2C" gate="G$1" pin="1"/>
</segment>
</net>
<net name="SDA" class="0">
<segment>
<pinref part="U2" gate="ARDUINO" pin="PC4/AD4/D18/SDA"/>
<wire x1="-148.59" y1="-21.59" x2="-148.59" y2="-30.48" width="0.1524" layer="91"/>
<label x="-148.59" y="-30.48" size="1.778" layer="95" rot="R90"/>
</segment>
<segment>
<wire x1="16.51" y1="-16.51" x2="24.13" y2="-16.51" width="0.1524" layer="91"/>
...
<net name="TX" class="0">
<segment>
<pinref part="U2" gate="ARDUINO" pin="PD1/D1/TX"/>
<label x="-148.59" y="41.91" size="1.778" layer="95" rot="R90"/>
<wire x1="-148.59" y1="39.37" x2="-148.59" y2="44.45" width="0.1524" layer="91"/>
</segment>
<segment>
<wire x1="-11.43" y1="-16.51" x2="-6.35" y2="-16.51" width="0.1524" layer="91"/>
<label x="-5.08" y="-16.51" size="1.778" layer="95"/>
<pinref part="UART" gate="G$1" pin="2"/>
</segment>
</net>
<net name="RX" class="0">
<segment>
<pinref part="U2" gate="ARDUINO" pin="PD0/D0/RX"/>
<label x="-146.05" y="41.91" size="1.778" layer="95" rot="R90"/>
<wire x1="-146.05" y1="39.37" x2="-146.05" y2="44.45" width="0.1524" layer="91"/>
</segment>
<segment>
<wire x1="-11.43" y1="-19.05" x2="-6.35" y2="-19.05" width="0.1524" layer="91"/>
<label x="-5.08" y="-19.05" size="1.778" layer="95"/>
<pinref part="UART" gate="G$1" pin="1"/>
</segment>
</net>
<net name="DO_A" class="0">
<segment>
<pinref part="U2" gate="ARDUINO" pin="MISO"/>
<wire x1="-127" y1="2.54" x2="-120.65" y2="2.54" width="0.1524" layer="91"/>
<label x="-124.46" y="2.54" size="1.778" layer="95"/>
</segment>
<segment>
<pinref part="U1" gate="D" pin="Y"/>
<wire x1="-53.34" y1="-19.05" x2="-46.99" y2="-19.05" width="0.1524" layer="91"/>
<label x="-49.53" y="-19.05" size="1.778" layer="95"/>
</segment>
</net>
<net name="5V" class="0">
<segment>
<pinref part="U2" gate="ARDUINO" pin="5V"/>
<wire x1="-176.53" y1="-21.59" x2="-176.53" y2="-30.48" width="0.1524" layer="91"/>
<label x="-176.53" y="-30.48" size="1.778" layer="95" rot="R90"/>
</segment>
<segment>
<pinref part="U3" gate="G$1" pin="VIN"/>
<wire x1="-12.7" y1="60.96" x2="-13.97" y2="60.96" width="0.1524" layer="91"/>
<label x="-17.78" y="60.96" size="1.778" layer="95"/>
<pinref part="C3" gate="C" pin="2"/>
<wire x1="-13.97" y1="60.96" x2="-19.05" y2="60.96" width="0.1524" layer="91"/>
<wire x1="-13.97" y1="57.15" x2="-13.97" y2="60.96" width="0.1524" layer="91"/>
<junction x="-13.97" y="60.96"/>
</segment>
<segment>
...
<segment>
<wire x1="-11.43" y1="-13.97" x2="-6.35" y2="-13.97" width="0.1524" layer="91"/>
<label x="-5.08" y="-13.97" size="1.778" layer="95"/>
<pinref part="UART" gate="G$1" pin="3"/>
</segment>
<segment>
<wire x1="16.51" y1="-13.97" x2="24.13" y2="-13.97" width="0.1524" layer="91"/>
...
<pinref part="U1" gate="D" pin="A"/>
<wire x1="-71.12" y1="-19.05" x2="-76.2" y2="-19.05" width="0.1524" layer="91"/>
</segment>
</net>
<net name="N$3" class="0">
<segment>
<pinref part="R3" gate="R" pin="2"/>
<pinref part="U1" gate="B" pin="A"/>
...
<wire x1="-71.12" y1="24.13" x2="-76.2" y2="24.13" width="0.1524" layer="91"/>
</segment>
</net>
<net name="N$5" class="0">
<segment>
<pinref part="R1" gate="R" pin="2"/>
<pinref part="U1" gate="C" pin="A"/>
